...
namespace Fractions
{
    public class Simplex_method
    {
        ...
        public List<List<SimpleFractions>> SimplexMethod(MatrixFractions matrix, List<int> basis, List<SimpleFractions> F, bool min, bool printAnswer)
        {
        ...
        public List<List<SimpleFractions>> SimplexMethod(List<List<SimpleFractions>> table, List<int> basis, List<SimpleFractions> F, bool min, bool printAnswer)
        {
            List<SimpleFractions> co = new List<SimpleFractions>();
            var search = Search(table, basis, co);
            PrintTable(table, basis, co);
        ...
        /// Вывод таблицы
        /// </summary>
        public void PrintTable(List<List<SimpleFractions>> list, List<int> basis, List<SimpleFractions> co)
        {
